...
export default function Certificates() {
  ...
  return (
    <section id="certificates" className="relative min-h-screen py-32 px-8 md:px-24 flex flex-col items-center justify-center">
      <h2 className="font-heading text-4xl md:text-6xl mb-24 text-center">Accreditations</h2>
      ...
      <motion.div
        ...
        className="relative w-full max-w-xl aspect-[1.414] glass-panel rounded-xl cursor-pointer group shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
      >
        <div 
          style={{ transform: "translateZ(50px)" }}
          className="absolute inset-0 p-12 flex flex-col items-center justify-center text-center border border-white/5 rounded-xl bg-gradient-to-br from-white/5 to-transparent pointer-events-none"
        >
          <div className="w-16 h-16 rounded-full bg-accent/20 flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(113,231,255,0.4)] group-hover:scale-110 transition-transform duration-500">
            <span className="font-display text-accent text-2xl font-bold">G</span>
          </div>
          <h3 className="font-heading text-3xl mb-2 text-textMain tracking-wide">Google AI Professional</h3>
          <p className="font-body text-accent tracking-widest uppercase text-xs mb-8">Certificate by Coursera</p>
          
          <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-xs font-body text-textSecondary opacity-70">
